...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "off your aim. Your laser hits his costume but misses entirely. This"
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print "As you die you see another Gothon rantically try to disarm"
            ...
            print "and the Gothons but their hands up and start to sweat."
            print "You inch backward at the door, open it, and carefully"
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
           ...
           print "The pod easily slides into space heading to"
           print "The planet below. As it flies into space you look"
